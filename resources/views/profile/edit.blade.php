            ...
            <section class="flex items-start my-5 space-x-4 p-5 bg-gray-800/40 border border-gray-600 rounded-xl">
                <div class="relative">
                    <img 
                        ...
                        class="lg:w-20 lg:h-20 w-16 h-16 rounded-full border-2 border-slate-700 shadow"
                        alt="{{ $user->fullname }}"
                        id="profileImage">
...
>
    ...
    ></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-0.5 lg:gap-2 mb-20">
            ...
            >
                ...
                >
                    ...
                    <form 
                        ...
                        @submit="if (new_password !== confirm_password) { alert('Password confirmation does not match!'); $event.preventDefault(); }"
                    >
                        @csrf
