...
class CalendarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        for ($day = 1; $day <= $daysInMonth; $day++) {
            ...
            $calendar[$day] = [
                'date' => $date,
                'posts' => $posts->filter(fn($p) => $p->post_at->isSameDay($date)),
            ];
        }

        return view('calendar.page', compact(
            'posts', 'month', 'year', 'months', 'yearRange', 'calendar', 'startDayOfWeek', 'daysInMonth'
        ));
    }
    ...
    public function list(Request $request)
    {
        ...
        // Ambil semua post di tanggal itu
